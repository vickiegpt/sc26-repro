...
#todo jkgreen needs to work on tex file here 
The report can be used in two scenarios: <<< this needs adjusting (along with tex file) to account for addendum style inclusions still
