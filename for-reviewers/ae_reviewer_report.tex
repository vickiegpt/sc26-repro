...
% Set to false to omit the author block from the title page.
\setboolean{showauthor}{false}
...
\begin{itemize}
    ...
    \item e.g., "The artifact evaluation was conducted from July 24, 2026, to July 31, 2026."
    \item e.g., "Artifact evaluation was carried out on July 24, 2026."
\end{itemize}
\end{aerhint}
